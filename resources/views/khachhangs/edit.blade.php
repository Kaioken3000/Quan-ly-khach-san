    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Cập nhật Phòng</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('khachhangs.update', $khachhang->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="diem">Điểm khách hàng</label>
                        <input type="number" name="diem" class="form-control" id="diem" min=0 required value="{{$khachhang->diem}}"/>
                        @error('diem')
