    ...
    <div class="card-box m-4">
        ...
        <div class="table-responsive card-body">
            ...
            <form action="{{ route('thanhtoanvnpay') }}" id="frmCreateOrder" method="post">
                ...
                <input readonly  hidden type="text" value="{{ $request->datphongid }}" name="datphongid">
                <input readonly  hidden type="text" value="{{ $request->loaitien }}" name="loaitien">
                <input readonly  hidden type="text" value="{{ $request->khachhangid }}" name="khachhangid">
                <input readonly  hidden type="text" value="{{ $request->tiendiem }}" name="tiendiem">
                <input readonly  hidden type="text" value="{{ $request->sotiendiem }}" name="sotiendiem">
            </form>
        </div>
        <p>
            &nbsp;
