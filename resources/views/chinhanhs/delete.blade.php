...
<button type="button" class="btn btn-link" style="color:red" data-bs-toggle="modal"
    data-bs-target="#basicModal{{ $chinhanh->id }}">
    <i class="icon-copy fas fa-trash"></i>
</button>
<a href="#"></a>
<!-- Modal xoá  -->
<div class="modal fade" id="basicModal{{ $chinhanh->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex gap-1">
                    ...
                    <form action="{{ route('chinhanhs.destroy', $chinhanh->id) }}" method="Post">
                        @csrf
                        @method('DELETE')
