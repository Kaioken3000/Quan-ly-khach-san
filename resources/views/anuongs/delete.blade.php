...
<button type="button" class="btn btn-link" style="color:red" data-bs-toggle="modal"
    data-bs-target="#basicModal{{ $anuong->id }}">
    <i class="icon-copy fas fa-trash"></i>
</button>
<!-- Modal xoá  -->
<div class="modal fade" id="basicModal{{ $anuong->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex gap-1">
                    ...
                    <form action="{{ route('anuongs.destroy', $anuong->id) }}" method="Post">
                        @csrf
                        @method('DELETE')
