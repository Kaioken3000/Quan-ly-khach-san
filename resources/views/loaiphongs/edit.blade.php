...
<div class="container mt-2">
  ...
  <div class="pull-right">
    <a class="btn btn-primary" href="{{ route('loaiphongs.index') }}">
      Back
    </a>
  </div>
        ...
        <div class="card-body">
          <form action="{{ route('loaiphongs.update',$loaiphong->ma) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="ma" class="form-control" value="{{ $loaiphong->ma }}" id="ma" placeholder="VD: P1" />
              @error('ma')
            ...
            <div class="mb-3">
              ...
              <input type="text" name="ten" class="form-control" id="ten" value="{{ $loaiphong->ten }}" placeholder="VD: Phòng VIP" />
              @error('ten')
              <div class="alert alert-danger" role="alert">{{ $message }}</div>
              @enderror
            </div>
            <div class="mb-3">
              ...
              <input type="number" name="gia" class="form-control" value="{{ $loaiphong->gia }}" id="gia" min=0 />
              @error('gia')
              <div class="alert alert-danger" role="alert">{{ $message }}</div>
              @enderror
            </div>
            <div class="mb-3">
              ...
              <textarea id="mieuTa" name="mieuTa" class="form-control" placeholder="VD: Phòng đẹp, tiện nghi,..">{{ $loaiphong->mieuTa }}</textarea>
              @error('mieuTa')
              <div class="alert alert-danger" role="alert">{{ $message }}</div>
              @enderror
            </div>
