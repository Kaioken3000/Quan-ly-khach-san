                    ...
                    <td>
                        ...
                        <div class="d-flex">
                            ...
                            <form class="m-1" action="/datphongs-kiemtra-capnhat" method="get">
                                ...
                                <button class="w-100 btn btn-primary" type="submit"><i class="fa fa-key mb-1"></i> Đổi phòng</button>
                            </form>
                            ...
                            <div class="m-1">
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#huydatphong{{ $datphong->datphongid }}">
                        ...
                        <div>
                            ...
                            @if($check!=0)
                            <div class="m-1">
                                <button type="button" class="w-100 btn btn-warning" data-toggle="modal" data-target="#modalthanhtoan{{ $datphong->datphongid }}">
                                    <i class="fa fa-check mb-1"></i> Thanh toán
                                </button>
                            </div>
                            @endif
                            <!-- Modal thanh toán -->
                            ...
                            @hasrole('Admin')
                            <div class="m-1">
                                <button type="button" class="w-100 btn btn-secondary" data-toggle="modal" data-target="#nhanphong{{ $datphong->datphongid }}">
                        ...
                        <form class="mb-1" action="{{ route('datphongs.chinhthanhtoan',$datphong->datphongid) }}" method="Post">
                            ...
                            <input type="hidden" name="id" value="{{ $datphong->datphongid }}">
                            <input type="hidden" name="khachhang_id" value="{{ $datphong->id }}">
                            <button type="submit" class="w-100 btn btn-warning"><i class="fa fa-rotate-right mb-1"></i> Sửa thanh
                                toán</button>
                        </form>
                        @endcan
                        <form action="generate-invoice-pdf" method="get">
                            @csrf
                            <input type="hidden" name="id" value="{{ $datphong->datphongid }}">
                            <button type="submit" class="w-100 btn btn-info"><i class="fa fa-receipt mb-1"></i> In hoá
                                đơn</button>
                        </form>
                        @endif
                    </td>
