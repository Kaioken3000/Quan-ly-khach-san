    ...
    <div class="container">
        ...
        <div class="row g-4 g-lg-5">
            ...
            <div class="col-lg-6 position-relative mb-4 mb-md-0">
                <!-- Title -->
                <h1 class="mb-4 mt-md-5 display-5">Tìm khách sạn
                    <span class="position-relative z-index-9">Hàng đầu.
                        <!-- SVG START -->
                        <span
                ...
                <!-- Info -->
                <p class="mb-4">
                    Chúng tôi mang đến cho bạn không chỉ một lựa chọn lưu trú mà còn là trải nghiệm phù hợp túi tiền của
                    bạn thưởng thức sự sang trọng.</p>
                ...
                <div class="hstack gap-4 flex-wrap align-items-center">
                    ...
                    <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo"
                        ...
                        <div class="avatar avatar-md z-index-1 position-relative me-2">
                            <img class="avatar-img rounded-circle" src="/booking/assets/images/avatar/12.jpg"
                                alt="avatar">
                            <!-- Video button -->
                            <div
                        ...
                        <div class="align-middle d-inline-block">
                            <h6 class="fw-normal small mb-0">Xem câu chuyện của chúng tôi</h6>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 position-relative">
                ...
                <img src="/booking/assets/images/bg/06.jpg" class="rounded" alt="">
                ...
                <div class="position-absolute top-0 end-0 z-index-1 mt-n4">
                    <div class="bg-blur border border-light rounded-3 text-center shadow-lg p-3">
                        ...
                        <h6 class="text-dark fw-light small mb-0">Hướng dẫn hỗ trợ
                        </h6>
                    </div>
                </div>
                ...
                <div
                    ...
                    <img class="icon-lg shadow-lg border border-3 border-white rounded-circle"
                        src="/booking/assets/images/category/hotel/4by3/11.jpg" alt="avatar">
                    <img class="icon-xl shadow-lg border border-3 border-white rounded-circle"
                        src="/booking/assets/images/category/hotel/4by3/12.jpg" alt="avatar">
                </div>
            </div>
        </div>
        <!-- Content and Image END -->

        @include('client.layouts3.kiemtraphongtrong')
    </div>
</section>
<!-- ======================= Main Banner END -->
