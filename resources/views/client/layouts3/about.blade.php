    ...
    <div class="container">
        <div class="row g-4 justify-content-between align-items-center">
            ...
            <div class="col-lg-5 position-relative">
                ...
                <!-- Image -->
                <img src="/booking/assets/images/about/01.jpg" class="rounded-3 position-relative" alt="">
                ...
                <div class="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
                    <div class="bg-body d-flex d-inline-block rounded-3 position-relative p-3">
                        ...
                        <!-- Element -->
                        <img src="/booking/assets/images/element/01.svg"
                        ...
                        <div class="me-4">
                            ...
                            <ul class="avatar-group mb-0">
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="/booking/assets/images/avatar/01.jpg"
                                        alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="/booking/assets/images/avatar/02.jpg"
                                        alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="/booking/assets/images/avatar/03.jpg"
                                        alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" src="/booking/assets/images/avatar/04.jpg"
                                        alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
