    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                <!-- logo -->
                <a href="index.html">
                    <img class="h-40px" src="/booking/assets/images/logo-light.svg" alt="logo">
                </a>
            ...
            <div class="col-sm-7 col-md-6 col-lg-4">
                ...
                <ul class="list-inline mb-0 mt-3">
                    <li class="list-inline-item"> <a href="#"><img
                                src="/booking/assets/images/element/paypal.svg" class="h-30px" alt=""></a>
                    </li>
                    <li class="list-inline-item"> <a href="#"><img
                                src="/booking/assets/images/element/visa.svg" class="h-30px" alt=""></a></li>
                    <li class="list-inline-item"> <a href="#"><img
                                src="/booking/assets/images/element/mastercard.svg" class="h-30px"
                                alt=""></a>
                    </li>
                    <li class="list-inline-item"> <a href="#"><img
                                src="/booking/assets/images/element/expresscard.svg" class="h-30px"
                                alt=""></a>
                    </li>
                </ul>
            </div>
