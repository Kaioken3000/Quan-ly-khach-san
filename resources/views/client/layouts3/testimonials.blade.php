                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 col-lg-5 position-relative">
                                    ...
                                    <div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
                                        <img src="/booking/assets/images/element/02.svg"
                                    ...
                                    <!-- Image -->
                                    <img src="/booking/assets/images/team/01.jpg" class="rounded-3 position-relative"
                                        alt="">
                                </div>
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 col-lg-5 position-relative">
                                    ...
                                    <div class="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
                                        <img src="/booking/assets/images/element/03.svg"
                                    ...
                                    <!-- Image -->
                                    <img src="/booking/assets/images/team/02.jpg" class="rounded-3 position-relative"
                                        alt="">
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <h5 class="fw-light">Passage its ten led hearted removal cordial.
                                        Preference
                                        any astonished unreserved Mrs. understood the Preference unreserved.
                                    </h5>
                                    <!-- Rating -->
                                    <ul class="list-inline small mb-2">
                                        <li class="list-inline-item me-0"><i class="fa-solid fa-star text-warning"></i>
