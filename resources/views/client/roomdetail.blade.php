...
<body>
    ...
    <section class="site-hero inner-page overlay" style="background-image: url(/client/images/hero_4.jpg)" data-stellar-background-ratio="0.5">
        <div class="container">
...
<body>
    ...
    @include('client.layouts2.roomDetail')
