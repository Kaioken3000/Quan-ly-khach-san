        ...
        @foreach ($datphongs as $datphong)
            <tr>
                ...
                <td>
                    ...
                    <!-- Modal -->
                    @include('client.layouts2.yourRoomDetailModal')
                </td>
                <td>
                    ...
                    @if ($datphong->tinhtrangthanhtoan == 0)
                        <div class="d-flex">
                            ...
                            @if ($datphong->tinhtrangnhanphong == 0)
                                ...
                                <!-- Modal xoá phòng -->
                                <div class="modal fade" id="basicModal{{ $datphong->datphongid }}" tabindex="-1"
                                    aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="d-flex gap-1">
                                                    ...
                                                    <form
                                                        action="{{ route('client.xoadatphong', $datphong->datphongid) }}"
                                                        method="Post">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            @else
                                ...
                                <!-- Modal dịch vụ -->
                                <div class="modal fade" id="modaldichvu{{ $datphong->datphongid }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('client.dichvu_satphong_store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <input hidden type="text" value="{{ $datphong->datphongid }}"
                                                        id="datphongid" name="datphongid">
                                                    <div class="mb-3">
                                                        ...
                                                        @foreach ($dichvus as $dichvu)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="dichvu{{ $dichvu->id }}" name="dichvuid[]"
                                                                    value="{{ $dichvu->id }}">
                                                                <label class="form-check-label"
                                                                    for="dichvu{{ $dichvu->id }}">
                                                                    {{ $dichvu->ten }}:
                                                                </label>
                                                                <label class="form-check-label"
                                                                    for="dichvu{{ $dichvu->id }}">
