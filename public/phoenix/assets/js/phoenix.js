(function(global, factory) {
    ...
    const echartSetOption = (e, t, o, n) => {
        ...
        c && c.addEventListener("navbar.vertical.toggle", (() => {
            ...
            e.resize(), n && s(n);
        })), n && s(n), i.addEventListener("clickControl", (({
            detail: {
                control: n
            }
        }) => {
    ...
    const reportsDetailsChartInit = () => {
        const {
            ...
            getData: a,
            toggleColor: e
        } = window.phoenix.utils, o = document.querySelector(".echart-reports-details"), r = (t, a = "MMM DD") => {
            let e = "";
            return t.forEach((t => {
        ...
        listInit = () => {
            ...
            if (window.List) {
                ...
                t.length && t.forEach((t => {
                    ...
                    const f = () => {
                        c && (c.innerHTML = `${g.i} to ${b} <span class='text-600'> Items of </span>${d}`), s && togglePaginationButtonDisable(s, 1 === p || 0 === p), i && togglePaginationButtonDisable(i, p === m || 0 === p), p > 1 && p < m && (togglePaginationButtonDisable(i, !1), togglePaginationButtonDisable(s, !1));
                    };
                    f(), i && i.addEventListener("click", (e => {
                    ...
                    if (l && l.addEventListener("click", (() => {
                        ...
                        r.addEventListener("change", (t => {
                            g.filter((a => "" === t.target.value || (m = Math.ceil(g.matchingItems.length / g.page), p = 1, f(), a.values()[e].toLowerCase().includes(t.target.value.toLowerCase()))));
                        }));
                    }
                    if (a) {
    ...
    const handleNavbarVerticalCollapsed = () => {
        const {
            ...
            setItemToStore: t,
            resize: a
        } = window.phoenix.utils, o = "body", n = ".navbar-vertical", l = ".navbar-vertical-toggle", r = ".navbar-vertical .navbar-collapse", c = ".navbar-vertical .nav-link.active", i = "click", s = "navbar.vertical.toggle", d = "navbar-vertical-collapsed", v = document.querySelector(l), m = document.querySelector(r), u = document.querySelector(c), b = e("phoenixIsNavbarVerticalCollapsed", !1);
    ...
    const randomColorInit = () => {
        const {
            getData: o
        } = window.phoenix.utils, t = document.querySelectorAll("[data-random-color]"), r = ["#EFF2F6", "#E3E6ED", "#CBD0DD", "#85A9FF", "#60C6FF", "#90D67F", "#F48270", "#FFCC85", "#3874FF", "#0097EB", "#25B003", "#EC1F00", "#E5780B", "#004DFF", "#0080C7", "#23890B", "#CC1B00", "#D6700A", "#222834", "#3E465B", "#6E7891", "#9FA6BC"];
        t.forEach((t => {
    ...
    const {
        ...
        e && e.querySelectorAll("[data-theme-control]").forEach((e => {
            ...
            if ("phoenixNavbarVerticalStyle" === a && ("horizontal" === n || "dual-nav" === n) && e.setAttribute("disabled", !0), "checkbox" === e.type) "phoenixTheme" === a ? "dark" === r && e.setAttribute("checked", !0) : r && e.setAttribute("checked", !0);
        ...
        }, a = new DomNode(document.body), r = document.querySelector(".navbar-vertical"), n = document.querySelector(".navbar-top"), i = document.querySelector(".support-chat-container");
        initialDomSetup(a.node), a.on("click", (e => {
            ...
            if (c.data("theme-control")) {
                ...
                switch ("phoenixTheme" === l && "boolean" == typeof d && (d = d ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({
                    [l]: d
                    ...
                    case "phoenixNavbarVerticalStyle":
                        r.classList.remove("navbar-darker"), "default" !== d && r.classList.add(`navbar-${d}`);
                        break;
                    case "phoenixNavbarTopStyle":
                        n.classList.remove("navbar-darker"), "transparent" !== d && n.classList.add(`navbar-${d}`);
                        break;
                    ...
                    case "phoenixSupportChat":
                        i ? .classList.remove("show"), d && i ? .classList.add("show");
                        break;
                    case "reset":
    ...
    const wizardInit = () => {
        const {
            getData: e
        } = window.phoenix.utils, t = "[data-theme-wizard]", a = "[data-wizard-step]", s = "[data-wizard-form]", r = "[data-wizard-password]", d = "[data-wizard-confirm-password]", l = "[data-wizard-next-btn]", n = "[data-wizard-prev-btn]", o = "[data-wizard-footer]", i = "theme-wizard-progress", c = "submit", u = "show.bs.tab", w = "shown.bs.tab", h = "click";
        document.querySelectorAll(t).forEach((t => {
            ...
            let q = 0,
                S = null;
            v.forEach((e => {
                e.addEventListener(c, (t => (t.preventDefault(), e.classList.contains("needs-validation") && (b && p && (b.value !== p.value ? p.setCustomValidity("Invalid field.") : p.setCustomValidity("")), !e.checkValidity()) ? (S.preventDefault(), !1) : (q += 1, null))));
                ...
                t.addEventListener(u, (a => {
                    ...
                    q = a, q !== m.length - 1 || z || m.forEach((e => {
