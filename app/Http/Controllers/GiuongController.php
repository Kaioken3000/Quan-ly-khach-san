...
class GiuongController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->withMessage('success', 'Giuong has been created successfully.');
    }
    ...
    public function update(Request $request, Giuong $giuong)
    {
        ...
        return redirect()->back()->withMessage('success', 'Giuong Has Been updated successfully');
    }
    ...
    {
        $giuong->delete();
        return redirect()->back()->withMessage('success', 'Giuong has been deleted successfully');
    }
